...
const struct Component::key_value Component::kMarkerMap[] = {
  ...
  { Component::kTempurature, "<Tempurature>"},
  { Component::kBlockSoftmaxTempurature, "<BlockSoftmaxTempurature>"},
};
...
Component* Component::NewComponentOfType(ComponentType comp_type,
  ...
  switch (comp_type) {
    ...
    case Component::kParallelComponent :
      ...
      break;
    case Component::kTempurature :
      //KALDI_ERR << "component is Tempurature ! " << TypeToMarker(comp_type);
      ans = new Tempurature(input_dim, output_dim);
      break;
